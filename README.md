This is a Feedback widget for users to send messages on different subjects with screenshots with only one click, whithout manipulating files or other apps to send the image.
